    ...
    return (
        <>
            <div className={`bg-[#000ea6]/10 h-full p-5 overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ""}`}>
                ...
                <div className="bg-[#261f40] rounded-full flex items-center gap-2 mt-[10px] mb-[10px] px-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-8 py-2">
                        <path
                            strokeLinecap="round"
