...
const RightSidebar =({selectedUser}) => {
  return selectedUser && (
    <div className={`bg-[#00ffe0]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden":""}`}>
      <div className='pt-10 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
        <img src={selectedUser.avatar || avatar_icon} alt='' className='w-20 aspect-[1/1] rounded-full'/>
      ...
      <div className='px-5 text-xs'>
        <p>Media</p>
        <div className='mt-2 max-h-[320px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80'>
